  ...
  return (
    <div className="min-h-screen pt-32 md:pt-24 pb-32 px-6 max-w-2xl mx-auto fade-in">
            ...
            {quizCompleted && !isLoggedIn && (
              <div className="flex flex-col gap-2 z-20 fade-in shrink-0 w-full md:w-auto md:absolute md:left-0 md:top-0 mb-6 md:mb-0">
                <button
                  ...
                  className="bg-[#FEE500] text-black px-4 py-3 rounded-2xl text-xs md:text-sm font-bold shadow-md hover:bg-[#F4DC00] hover:-translate-y-0.5 transition-transform flex items-start gap-2 w-fit"
                >
                  <KakaoIcon className="w-4 h-4 fill-current mt-0.5" />
                  <div className="text-left leading-snug">
                    카카오톡<br/>간편<br/>로그인/회원가입
                  </div>
                </button>
              </div>
            )}
      ...
      {isLoggedIn && quizCompleted && (
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 w-[calc(100%-2rem)] max-w-lg bg-white/80 backdrop-blur-xl border border-gray-200/50 shadow-2xl p-2 md:p-3 rounded-3xl z-50 flex flex-wrap sm:flex-nowrap justify-between gap-2 fade-in">
          <button
            id="kakao-share-bottom"
            onClick={() => alert('카카오톡 공유가 완료되었습니다.')}
            className="flex-1 min-w-[45%] bg-[#FEE500] text-black py-3 rounded-2xl text-xs md:text-sm font-bold shadow-sm hover:bg-[#F4DC00] hover:-translate-y-0.5 transition-transform flex items-center justify-center gap-1.5"
          >
          ...
          <button
            ...
            className="flex-1 min-w-[45%] bg-gradient-to-r from-purple-500 via-pink-500 to-orange-400 text-white py-3 rounded-2xl text-xs md:text-sm font-bold shadow-sm hover:-translate-y-0.5 transition-transform flex items-center justify-center gap-1.5"
          >
            📸 인스타그램 공유
          </button>
          <button
            id="go-to-lab-bottom"
            onClick={() => setView('lab')}
            className="flex-1 min-w-[45%] bg-black text-[#c0ff00] py-3 rounded-2xl text-xs md:text-sm font-bold shadow-sm hover:bg-gray-800 hover:-translate-y-0.5 transition-transform flex items-center justify-center gap-1.5"
          >
            🎧 BMTI 플리 신청
          </button>
          <button
            ...
            className="flex-1 min-w-[45%] bg-white text-black border border-gray-200 py-3 rounded-2xl text-xs md:text-sm font-bold shadow-sm hover:bg-gray-50 hover:-translate-y-0.5 transition-transform flex items-center justify-center gap-1.5"
          >
